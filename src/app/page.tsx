  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-300">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16">
        <div className="max-w-4xl mx-auto w-full">
          <div className="space-y-6">
            <p className="text-emerald-400 font-mono text-base">
              Hi, my name is
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-slate-200">
              Riches Ogigi.
            </h1>
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-slate-400">
      ...
      <section id="about" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-200 mb-8 sm:mb-12">
            <span className="text-emerald-400 font-mono text-lg sm:text-xl mr-2">01.</span> About Me
          </h2>
      ...
      <section id="experience" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-200 mb-8 sm:mb-12">
            <span className="text-emerald-400 font-mono text-lg sm:text-xl mr-2">02.</span> Where I've Worked & Studied
          </h2>
      ...
      <section id="projects" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-200 mb-8 sm:mb-12">
            <span className="text-emerald-400 font-mono text-lg sm:text-xl mr-2">03.</span> Some Things I've Built
          </h2>
          ...
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
              <div className="lg:col-span-7 order-2 lg:order-1">
                <div className="relative group">
                  <div className="bg-slate-800 rounded-lg p-6 sm:p-8 h-48 sm:h-64 flex items-center justify-center border border-slate-700">
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 font-mono text-sm sm:text-base">Real-time Chat Application</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="lg:col-span-5 order-1 lg:order-2">
                <div className="lg:text-right space-y-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-200">Convo</h3>
                  ...
                  <div className="flex flex-wrap gap-2 lg:justify-end">
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">NestJS</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">PostgreSQL</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">Redis</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">WebSocket</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">NextJS</span>
                  </div>
            ...
            <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
              <div className="lg:col-span-5">
                <div className="space-y-4">
                  <p className="text-emerald-400 font-mono text-sm">Featured Project</p>
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-200">CourseFlow Backend</h3>
                  <div className="bg-slate-800 p-4 sm:p-6 rounded-lg border border-slate-700">
                    <p className="text-slate-400 leading-relaxed text-sm sm:text-base">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">NestJS</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">TypeScript</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">PostgreSQL</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">Prisma ORM</span>
                    <span className="text-slate-400 font-mono text-xs sm:text-sm">JWT</span>
                  </div>
                  <div className="flex gap-4">
                    <Link href="#" className="text-slate-400 hover:text-emerald-400 transition-colors hover:transform hover:-translate-y-1 duration-200">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                      </svg>
                    </Link>
                ...
                <div className="relative group">
                  <div className="bg-slate-800 rounded-lg p-6 sm:p-8 h-48 sm:h-64 flex items-center justify-center border border-slate-700">
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 font-mono text-sm sm:text-base">Course Management System</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-200 mb-6 sm:mb-8">
            <span className="text-emerald-400 font-mono text-lg sm:text-xl mr-2">04.</span> What's Next?
          </h2>
          <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-200 mb-6 sm:mb-8">Get In Touch</h3>
      ...
      {/* Footer */}
      <footer className="py-6 sm:py-8 px-4 sm:px-6 lg:px-8 text-center border-t border-slate-800">
